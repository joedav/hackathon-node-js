  ...
  if (process.env.NODE_ENV === "production") {
    return client
      .get("statuses/user_timeline", {
        ...
        count: 10 // trocar para 20 quando for rodar no tweet e rudar com npm start
      })
      .then(tweets =>
        tweets.map(tweet => {
          return {
    ...
    try {
      ...
      const erro =
        '*** Atenção, seu JSON pode estar inválido ou você apagou ou renomeou o arquivo "tweets.json" da sua pasta raíz!! ***';
